                ...
                buttons: [{
                    ...
                    action: function action(button, e) {
                        ...
                        if (self._editingRack) {
                            ...
                            formData.pid = treeNode._parent._attrObject.id
                ...
                if (ht.Default.containedInView(e, self.gv)) {
                    if (dm.contains(self.dragHelper)) {
                        ...
                        if (target[1]) {
                            ...
                            datas.pid = node._parent._attrObject.id
                            deepFor(treeData, node._parent._attrObject.id, datas)
                            console.log(treeData, 223);
                            dm.remove(self.dragHelper);
                        } else {
                            dm.remove(self.dragHelper);
                        }
...
var Main = function() {
    ...
    createClass(Main, [{
        ...
        value: function loadTreeData() {
            ...
            $.ajax({
                    type: 'GET',
                    url: 'http://10.163.228.54:3000/api/croom/getData',
                    contentType: "application/json;charset=UTF-8",
                    data: {},
                    success(res) {
                        let data = res.data;
